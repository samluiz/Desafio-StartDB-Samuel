...
estadosEstaoCorretos =
    estadosEstaoCorretos &&
    validarEtapa(5, palavraEsperada, 'e', estadoEsperado, jogoForca)

jogoForca.chutar('d')
estadosEstaoCorretos =
    estadosEstaoCorretos &&
    validarEtapa(4, palavraEsperada, 'ed', estadoEsperado, jogoForca)
...
estadosEstaoCorretos =
    estadosEstaoCorretos &&
    validarEtapa(3, palavraEsperada, 'edu', estadoEsperado, jogoForca)
...
estadosEstaoCorretos =
    estadosEstaoCorretos &&
    validarEtapa(2, palavraEsperada, 'edum', estadoEsperado, jogoForca)

jogoForca.chutar('l')
estadosEstaoCorretos =
    estadosEstaoCorretos &&
    validarEtapa(1, palavraEsperada, 'eduml', estadoEsperado, jogoForca)
